...
*/
lipsync::lipsync(phoneme_estimator* pEstimator)
{
...
/**
  ...
  */
bool lipsync::initializeObjects()
{
    HRESULT hr = S_OK;
    m_err = L"";
    try
...
**/
void _stdcall 
lipsync::callback(WPARAM wParam, LPARAM lParam)
{
    lipsync* pThis = (sapi_lipsync*)lParam;
    pThis->callback();
}
...
void lipsync::finalize_phoneme_alignment()
{
...
**/
void lipsync::print_results(std::ostream& os)
{
...
/**
	...
	This will be used to heuristically spread the phonemes
	across the word time stamp. 
	@param pEstimator - [in] the estimator. Can be NULL
*/
textbased_lipsync::textbased_lipsync(phoneme_estimator* pEstimator) :
lipsync(pEstimator)
{
...
/** 
	destructor
**/
textbased_lipsync::~textbased_lipsync()
{
...
*/
bool 
textbased_lipsync::lipsync(const std::wstring& strAudioFile, const std::wstring& strText)
{
    HRESULT hr;
    try
    {
...
**/
void textbased_lipsync::callback()
{
    //USES_CONVERSION;
    CSpEvent event;
	...
	while (event.GetFrom(this->m_recogCntxt) == S_OK)
    {
		...
		{
			// text based has to accept hypothesis or it mostly fails
...
*/
void textbased_lipsync::print_results(std::ostream& os)
{
	lipsync::print_results(os);
...
/**
	busu is picky about the data input into the Command and Control system.
...
**/
std::wstring 
textbased_lipsync::preprocess_text(const std::wstring& in)
{
...
**/
bool textbased_lipsync::is_dirty_char(wchar_t in)
{
...
constructor
**/
textless_lipsync::textless_lipsync()
{
}
...
/**
	...
	@param pEstimator - [in] the estimator. Can be NULL
*/
textless_lipsync::textless_lipsync(phoneme_estimator* pEstimator) :
lipsync(pEstimator)
{
...
bool textless_lipsync::lipsync(const std::wstring& strAudioFile)
{
    HRESULT hr;
    try
    {
...
**/
void textless_lipsync::callback()
{
